<template>
  <div class="container">
    ...
    <div class="field">
      ...
      <div class="control">
        <textarea
          ...
          placeholder="Escreva algo sobre a senha aqui"
        >
        </textarea>
      </div>
    </div>
    ...
    <div class="buttons">
      ...
      <button class="button is-success" @click="onClickRegister()">
        Salvar
      </button>
    </div>
  </div>
...
export default class passwordForm extends Vue {
  ...
  private onClickRegister(): void {
    this.passwordClient.save(this.password).then(
      (success) => {
